...
import footer_logo from '@/app/assets/werugo/images/logo/footer_logo.svg'
import linkedin_icon from '@/app/assets/werugo/images/icons/linkedin_icon.svg'
import twitter_icon from '@/app/assets/werugo/images/icons/twitter_icon.svg'
import facebook_icon from '@/app/assets/werugo/images/icons/facebook_icon.svg'
import instagram_icon from '@/app/assets/werugo/images/icons/instagram_icon.svg'
...
export default function Footer() {
  ...
  return (
    <>
      <div className="text-white/80 bg-gradient-to-tr from-black to-black/80" >
        <div className="w-10/12 md:w-11/12 lg:w-[85%] 2xl:w-3/4 mx-auto py-3 flex flex-col gap-5 items-center lg:gap-0 lg:flex-row lg:justify-between">
          <div className="flex gap-1.5 items-center">
            <Image width={100} height={100}
              src={footer_logo}
              alt="footer_logo"
              className="w-4 pointer-events-none w-auto"
            />
          ...
          <div className="flex items-center flex-wrap gap-x-10 gap-y-5 justify-center">


            <button onClick={open} className="text-xs lg:text-sm font-medium hover:text-[#39AE56] ease-in-out duration-300 ">
              Privacy Policy
            </button>
            <button onClick={termOpen} className="text-xs lg:text-sm font-medium hover:text-[#39AE56] ease-in-out duration-300 ">
              Terms
            </button>


            <Link href='https://apprecial.com' className='rounded border border-[#BB6A37] text-[#BB6A37] hover:bg-[#BB6A37] hover:text-white ease-in-out duration-300 py-1 px-3 text-sm flex-1 text-center whitespace-nowrap'>Back to Apprecial</Link>
